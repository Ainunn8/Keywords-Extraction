...
with open('D:/UNILA/Semester6/NLP/Kewords-Extraction/Kewords-Extraction-App-machine-Learning-main/count_vectorizer.pkl', 'rb') as f:
    cv  = pickle.load(f)

with open('D:/UNILA/Semester6/NLP/Kewords-Extraction/Kewords-Extraction-App-machine-Learning-main/tfidf_transformer.pkl', 'rb') as f:
    tfidf_transformer = pickle.load(f)

with open('D:/UNILA/Semester6/NLP/Kewords-Extraction/Kewords-Extraction-App-machine-Learning-main/feature_names.pkl', 'rb') as f:
